...
function partsDoEvent {
	...
	for m in ship:modulesnamed(module) {
		set p to m:part.
...
function partsExtendWinches {
	parameter tag is "".
	partsDoEvent("KASLinkWinch", "extend cable", tag).
}

function partsRetractWinches {
	parameter tag is "".
	partsDoEvent("KASLinkWinch", "retract cable", tag).
}

function partsDetachWinches {
	parameter tag is "".
	partsDoEvent("KASLinkWinch", "detach connector", tag).
	partsDoEvent("KASLinkTargetBase", "detach connector", tag).
}
...
function partsDisarmChutes {
	return partsDoAction("ModuleParachute", "disarm").
}

function partsCutChutes {
	return partsDoAction("ModuleParachute", "cut chute").
}
